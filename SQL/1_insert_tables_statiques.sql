...
INSERT INTO `Utilisateur` (`id`, `nom`, `prenom`, `login`, `mdp`, `adresse`, `cp`, `ville`, `dateEmbauche`, `statut`) VALUES
...
('test', 'Test', 'Comptable', 'tcomptable', 'essai', 'Test adresse', '01234', 'Test Ville', '2000-01-01','2');
-- --------------------------------------------------------